package com.sparta.springmid.global.config;

import com.sparta.springmid.global.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, UserService userService)
        ...
        http.authorizeHttpRequests((auth) -> auth
                .requestMatchers("/api/auth/reissue", "/api/auth/sign-up", "/api/auth/login")
                .permitAll()
